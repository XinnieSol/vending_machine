...
class UserController {
    ...
    async login(req: Request, res: Response) {
        try {
            ...
            return appResponse(res, 200, "Login successful", result);
        } catch (error) {
            appResponse(
                res, 
                error.statusCode, 
    ...
    async logoutSessions(req: Request & AuthRequest, res: Response) {
        try {
            ...
            return appResponse(res, 200, "Logged out from all sessions successfully");
        } catch (error) {
            appResponse(
                res, 
                error.statusCode, 
    ...
    async deposit(req: Request & AuthRequest, res: Response) {
        try {
            ...
            return appResponse(res, 200, "deposit successful", result);
        } catch (error) {
            appResponse(
                res, 
                error.statusCode, 
    ...
    async resetBalance(req: Request & AuthRequest, res: Response) {
        try {
            ...
            return appResponse(res, 200, "Account balance reset successful", result);
        } catch (error) {
            appResponse(
                res, 
                error.statusCode, 
